    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
          $query=mysqli_query($con,"insert into appointmenttb(ID,pid,fname,lname,pname,email,contact,doctor,docFees,appdate,apptime,userStatus,doctorStatus) values($ID,$pid,'$fname','$lname','$pname','$email','$contact','$doctor','$docFees','$appdate','$apptime','1','1')");
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Welcome  Owner  &nbsp<?php echo $username ?>  </h3>
   </h3>
    <div class="row">
